...
microsoftexcel)
    ...
    downloadURL=$(curl -fsL "$MAUSource" | xmllint --xpath '//array/dict[1]/key[text()="FullUpdaterLocation"]/following-sibling::string[1]/text()' - 2>/dev/null | sed 's/_Updater/_Installer/')
